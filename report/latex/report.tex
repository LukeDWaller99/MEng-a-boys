...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\textsc{\LARGE University of Plymouth}\\[1.5cm] % Main heading such as the name of your university/college
	
	\textsc{\Large PROJ515}\\[0.5cm] % Major heading such as course name
	
	\textsc{\large MEng Project}\\[0.5cm] % Minor heading such as course title
	...
	{\huge\bfseries The Home Electric Vehicle Charging System (HEVCS)}\\[0.4cm] % Title of your document
	...
	\vfill\vfill
	\includegraphics[width=0.4\textwidth]{UOP_Logo.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
