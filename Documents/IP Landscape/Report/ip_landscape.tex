...
\end{table}
\subsubsection{Independent Claims Analysis}
...
\subsubsection{Independent Claim 1}
...
\subsubsection{Independent Claims Summary}
...
\subsubsection{Independent Claim Analysis}
...
\subsubsection{Independent Claim 2}
...
\subsubsection{Independent Claim 3}
...
\subsubsection{Independent Claim 8}
...
\subsubsection{Independent Claim 9}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Patent Information}
    \label{table:under_vehicle_patent_7}
\end{table}
...
\subsubsection{Independent Claim 14}
...
\subsubsection{Independent Claim 15}
...
%%%%%%%%%%%%%%%%%%%%%%%% end of 7
\subsubsection{Patents 8 and 9 - Patent Family - Internet-Based Grid Connection Type Microgrid Joint Energy Management and Control Method}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Patent Information}
    \label{table:under_vehicle_patent_8and9}
\end{table}
