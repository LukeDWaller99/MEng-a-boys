...
t_t1=time.ticks_ms()
t_t2=time.ticks_ms()
def f_sensing_loop(interface,interrupt1,interrupt2,bus,sensor,led1,led2,led3):
    while True:
        global iterations,int_led
        ...
        if sensor.data_ready():
            ...
            data = interface.sensor.get_data()
...
##kick off thread running the sensing loop
second_thread = _thread.start_new_thread(f_sensing_loop,[interface.interrupt_lines[0],interface.interrupt_lines[1],interface.bus,interface.sensor,led1,led2,led3])